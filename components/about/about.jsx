...
const AboutSection = () => {
  return (
    <section id="about" className="section-pad relative overflow-hidden bg-paper">
      <div className="pointer-events-none absolute -right-24 top-10 h-72 w-72 rounded-full bg-mint/70 blur-3xl" />
      <div className="pointer-events-none absolute -left-16 bottom-0 h-64 w-64 rounded-full bg-sand blur-3xl" />
      ...
      <div className="container-shell relative">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-[var(--muted)]">
            Kaldesigns focuses on three things: analysis you can act on,
            automation that sticks, and software engineering that ships. Branding
            and logo work are no longer part of the offer — so every conversation
            stays on systems that improve operations.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {points.map((point, index) => (
            <div key={point.title} className="relative pt-2">
              <div className="pipeline-pulse mb-5 h-px w-16 bg-forest" style={{ animationDelay: `${index * 0.4}s` }} />
